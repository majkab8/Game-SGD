...
def drawStatus(score, level):
    ...
    # draw cleared lines text
    clearedSurf = BASICFONT.render('Cleared lines: %s' % score, True, TEXTCOLOR)
    clearedRect = clearedSurf.get_rect()
    clearedRect.topleft = (WINDOWWIDTH - 150, 80)
    DISPLAYSURF.blit(clearedSurf, clearedRect)
