...
def showGameOverScreen():
    ...
    gameRect.center = (WINDOWWIDTH // 2, WINDOWHEIGHT // 2 - 50)

    continueFont = pygame.font.Font('freesansbold.ttf', 24)
    continueSurf = continueFont.render('Press any key to play again', True, WHITE)
    continueRect = continueSurf.get_rect()
    continueRect.center = (WINDOWWIDTH // 2, WINDOWHEIGHT // 2 + 10)
